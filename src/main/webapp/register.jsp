...
<head>
    ...
    <style>
        /* Styles pour le pop-up d'erreur */
        .popup {
            display: none;
            position: fixed;
            top: 50%;
...
<form action="RegisterServlet" method="post" onsubmit="masquerErreur()">
    <div class="min-h-screen bg-gray-500 flex justify-center items-center">
        ...
        <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
            <div class="flex flex-col items-center justify-center">
                ...
                <h1 class="text-3xl font-bold text-center mb-4 cursor-pointer">S'inscrire</h1>
                    ...
                    <div class="flex items-center">
                        <div class="p-2">
                            <div class="flex items-center">
                                ...
                                <p class="px-6 py-4 text-red-900 font-semibold text-lg">Erreur lors de l'inscription</p>
                            </div>
            ...
            <div class="space-y-4">
                ...
                <input type="password" id="motDePasse" name="motDePasse" placeholder="Mot de passe"
                       class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" />
                <input type="password" id="motDePasseConformation" name="motDePasseConfirmation" placeholder="Confirmation mot de passe"
                       class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" />

            </div>
            <div class="text-center mt-6">
                <button class="py-3 w-64 text-xl text-white bg-gray-900 rounded-2xl">S'inscrire</button>
                <p class="mt-4 text-sm">Déjà inscrit? <span class="underline cursor-pointer"><a href="login.jsp"> Se connecter</a></span>
                </p>
            </div>
        </div>

                ...
                <span class="text-gray-600 ml-3">4 Avis</span>
                        ...
                        <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="relative">
                                    <select id="pointureDropdown" class="rounded border appearance-none border-gray-400 py-2 focus:outline-none focus:border-gray-900 text-base pl-3 pr-10">
                                        <% for (int i = 0; i < varianteProduit.size(); i++) { %>
                                            <option value="<%= varianteProduit.get(i).getId() %>"> <%= varianteProduit.get(i).getPointure() %></option>
                                        <%}%>
                                    </select>
...
<script>
    document.getElementById('ajouterAuPanierButton').addEventListener('click', function() {
        ...
        console.log("ID de la variante sélectionnée : " + idVariante); // Affichez l'ID de la variante dans la console

...
<form action="AdminLogin" method="post">
    <div class="min-h-screen bg-gray-500 flex justify-center items-center relative overflow-hidden">
        ...
        <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
                ...
                <div class="bg-red-50 border-l-8 border-red-900">
                    <div class="flex items-center">
                        <div class="p-2">
                            <div class="flex items-center">
                                <div class="ml-2">
                                    <svg id="SVG" class="h-8 w-8 text-red-900 mr-2 cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </div>
                                </button>
                                <p class="px-6 py-4 text-red-900 font-semibold text-lg">Erreur lors de la connexion</p>
                            </div>
            ...
            <div class="space-y-4">
                <input type="text" id="email" name="email" placeholder="Email" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" />
                <input type="password" id="motDePasse" name="motDePasse" placeholder="Mot de passe" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none" />
            </div>
            <div class="text-center mt-6">
                <button class="py-3 w-64 text-xl text-white bg-gray-900 rounded-2xl">Se connecter</button>
            </div>
...
<script>
    ...
    monSVG.addEventListener("click", function() {
        masquerErreur();
    });
    ...
    var erreur = "<%= request.getAttribute("erreur") %>";
